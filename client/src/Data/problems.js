const problems = [
...

    {
        ...
        testCases: [
            ...
            {
                inputs: [{ type: "array", value: [0, 8, 4, 12, 2] }],
                expectedOutput: 3,
            },
        ],
    },

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [7, 1, 5, 3, 6, 4] }],
                expectedOutput: 5,
            },
            {
                inputs: [
...

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [1, 0, 2] }],
                expectedOutput: 5,
            },
            {
                inputs: [{ type: "array", value: [1, 2, 2] }],
                expectedOutput: 4,
            },
        ],
    },

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [0, 1, 0, 3, 12] }],
                expectedOutput: [1, 3, 12, 0, 0],
            },
            {
                inputs: [{ type: "array", value: [1, 4, 0, 0, 0, 6, 8, 0, 3] }],
...

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [2, 3, 1, 1, 4] }],
                expectedOutput: 1,
            },
            {
                inputs: [{ type: "array", value: [3, 2, 1, 0, 4] }],
                expectedOutput: 0,
            },
        ],
    },
...

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [2, 0, 2, 1, 1, 0] }],
            ...
            },
            {
                inputs: [
                    {
                        type: "array",
                        value: [1, 2, 0, 1, 0, 2, 1, 0, 2, 2, 0, 1, 1, 0],
                    },
                ],
...

    {
        ...
        testCases: [
            ...
            {
                inputs: [{ type: "string", value: "race a car" }],
                expectedOutput: false,
            },
        ],
    },

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [3, 4, 5, 1, 2] }],
                expectedOutput: 1,
            },
            {
                inputs: [{ type: "array", value: [4, 5, 6, 7, 0, 1, 2] }],
                expectedOutput: 0,
            },
        ],
    },

    {
        ...
        testCases: [
            {
                inputs: [{ type: "array", value: [1, 2, 3, 4] }],
                expectedOutput: [24, 12, 8, 6],
            },
            {
                inputs: [{ type: "array", value: [2, 3, 4, 5] }],
    ...
    },
    {
        ...
        testCases: [
            ...
            {
                inputs: [{ type: "array", value: [4, 2, 0, 3, 2, 5] }],
                expectedOutput: 9,
            },
        ],
    },

    {
        ...
        testCases: [
            ...
            {
                inputs: [{ type: "array", value: ["dog", "racecar", "car"] }],
                expectedOutput: "",
            },
        ],
    },

    {
        ...
        testCases: [
            {
                inputs: [{ type: "string", value: "the sky is blue" }],
...

    {
        ...
        description:
            "Implement regular expression matching with support for '.' and '*'. The matching should cover the entire input string, not partial.",
