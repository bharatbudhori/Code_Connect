...
import { ProfileCard } from './sub-components/AboutCard';
  ...
  return (
    <>
        <div className='flex flex-wrap justify-center mt-20 gap-20'>
          ...
          <ProfileCard image_link="https://media.licdn.com/dms/image/D4D03AQGQ1ze2MukxQQ/profile-displayphoto-shrink_400_400/0/1690030694283?e=1705536000&v=beta&t=g1OIg8zOEYt8FMv-06Hc4Mloix4iM2VgeRjlyO3YmWE" name="Ekaspreet Singh" home="Narayana Vihar, Delhi" workplace="BasketHunt Pvt. Ltd." college="Guru Tegh Bahadur Institute of Technology" linkedin="https://www.linkedin.com/in/ekaspreet-singh-a979bb195/" github="https://github.com/EkaspreetSingh" instagram="https://www.instagram.com/singh_ekaspreet/"/>
        </div>
