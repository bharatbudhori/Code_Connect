          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex ml-8">
              <ul className="hidden md:flex">
                ...
                <li className="text-lg pr-8">
                    <button onClick={ ()=>showComponent('test result') } className={ `transition duration-300 ${activeComponent === 'test result' ? "text-yellow-500 underline":""} focus:outline-none focus:text-yellow-500 focus:underline hover:underline hover:text-yellow-500`} style={{textUnderlineOffset: '8px'}}>
                        Result
                    </button>
                </li>
              </ul>
